...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post eventos_url, params: { evento: { anoHipico: @evento.anoHipico, dataFim: @evento.dataFim, dataInicio: @evento.dataInicio, nome: @evento.nome } }
    end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { anoHipico: @evento.anoHipico, dataFim: @evento.dataFim, dataInicio: @evento.dataInicio, nome: @evento.nome } }
